...
export const metadata: Metadata = {
  title: 'I Am A Landlord | Cube Properties Group',
  description:
    'Complete the landlord form to work with Cube Properties Group.',
};
      ...
      <section className="relative pt-36 md:pt-44 pb-20 md:pb-24 px-4 sm:px-6 lg:px-8 bg-primary">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <p className="text-white/80 text-sm sm:text-base md:text-lg max-w-3xl mt-6 leading-relaxed">
            Please complete the form below to discuss your property needs.
          </p>
